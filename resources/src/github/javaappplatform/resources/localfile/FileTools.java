...
public class FileTools
{
	...
	public static final Set<OpenOption> parseWrite(int options)
	{
		...
		if (github.javaappplatform.resources.IResourceAPI.OpenOption.APPEND_TO_RESOURCE.isSetIn(options))
			oo.add(StandardOpenOption.APPEND);
		if (github.javaappplatform.resources.IResourceAPI.OpenOption.CREATE_IN_ANY_CASE.isSetIn(options))
		{
		...
		if (github.javaappplatform.resources.IResourceAPI.OpenOption.CREATE_ONLY_WHEN_NEW.isSetIn(options))
		{
			oo.add(StandardOpenOption.CREATE);
			oo.add(StandardOpenOption.WRITE);
		}
		if (github.javaappplatform.resources.IResourceAPI.OpenOption.DELETE_ON_CLOSE.isSetIn(options))
		{
...
//	}
	...
	{
		if (github.javaappplatform.resources.IResourceAPI.OpenOption.DELETE_ON_FAIL.isSetIn(options))
		{
			try
			{
